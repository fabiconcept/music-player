...
const Nowplaying = ({ music, canplay, data, loadedSong, seLoadedSong }) => {
    ...
    return (
        <section className={`playing ${large ? "large" : "small"}`}>
            <span>
                <div className="img" onClick={()=>setLarge(!large)}><img src={currentSong.img} alt="" /></div>
                <div className="txt">
            ...
            <span>
                ...
                <img src={circle} alt="" className='switch' onClick={()=>exitFullscreen()} />
            </span>
        </section>
    )
}
